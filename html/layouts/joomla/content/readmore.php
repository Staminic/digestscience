...
<?php elseif ($readmore = $item->alternative_readmore) : ?>
	<a class="readmore btn btn-outline-black" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
		<?php echo $readmore; ?>
...
<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
	<a class="readmore btn btn-outline-black" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo JText::_('COM_CONTENT_READ_MORE'); ?> <?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
