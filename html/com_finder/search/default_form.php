...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toUri()); ?>" method="get">
	...
	<?php endif; ?>
	<fieldset class="word class="input-group mb-3">
		<label for="q">
			<?php echo JText::_('COM_FINDER_SEARCH_TERMS'); ?>
		</label>

		<div class="input-group mb-3">
			<input type="text" name="q" id="q" size="30" value="<?php echo $this->escape($this->query->input); ?>" class="form-control" style="border-color: #4d9ebd;" />
