...
<div class="item-page page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<div class="container">
		...
		<div class="page-content">
			...
			<?php if ($params->get('show_title') || $params->get('show_author')) : ?>
              ...
              <?php if ($this->item->jcFields['dates-programme-de-recherche']->rawvalue) : ?>
                <span class="below-title"><?php echo $this->item->jcFields['dates-programme-de-recherche']->rawvalue; ?></span>
              <?php endif; ?>
						</h2>
					<?php else : ?>
          ...
          <?php if ($this->item->jcFields['intro']->rawvalue) : ?>
						<?php if ($this->item->jcFields['accroche']->rawvalue) : ?>
							<div class="row mb-4 intro-section">
								<div class="col-lg-8">
									<div class="lead">
          ...
          <?php if ($this->item->jcFields['colonne-droite']->rawvalue) : ?>
            <div class="row">
              <div class="col-md-8">
                <?php echo $this->item->text; ?>
              </div>
              <div class="col-md-4">
                <?php echo $this->item->jcFields['colonne-droite']->rawvalue; ?>
              </div>
            </div>
          <?php else : ?>
            <?php echo $this->item->text; ?>
