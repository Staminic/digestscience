...
<?php else : ?>
	<ul class="navbar-nav <?php echo $params->get('inline', 1) ? 'lang-inline' : 'lang-block'; ?>" dir="<?php echo JFactory::getLanguage()->isRtl() ? 'rtl' : 'ltr'; ?>">
	<?php foreach ($list as $language) : ?>
		<?php if (!$language->active) : ?>
			<li class="nav-item">
			...
			<?php if ($params->get('image', 1)) : ?>
				...
				<?php endif; ?>
			<?php else : ?>
				<?php echo $params->get('full_name', 1) ? $language->title_native : '<span>' . strtoupper($language->sef) . '</span>'; ?>
			<?php endif; ?>
			</a>
			</li>
		<?php elseif ($params->get('show_active', 1)) : ?>
