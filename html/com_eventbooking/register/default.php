...
<div class="container">
	<div class="page-content">
		<div id="eb-individual-registration-page" class="<?php echo $this->waitingList ? ' eb-waitinglist-individual-registration-form' : '';?>">
			<h1 class="h2 text-black"><?php echo $this->event->title . ' - ' . $headerText; ?></h1>
			<?php
			if (strlen($msg))
			{
			?>
			...
			<form method="post" name="adminForm" id="adminForm" action="<?php echo $url; ?>" autocomplete="off" class="form form-horizontal py-3" enctype="multipart/form-data">
			<?php
				if (!$this->userId && $this->config->user_registration)
				{
			...
			?>
				<div class="form-actions">
					<input type="button" class="btn btn-lg btn-primary" name="btnBack" value="<?php echo  JText::_('EB_BACK') ;?>" onclick="window.history.go(-1);" />
					<input type="submit" class="btn btn-lg btn-primary" name="btn-submit" id="btn-submit" value="<?php echo $buttonText;?>" />
